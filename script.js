...
class Factory {
  constructor(carInfo = {}) {
    ...
    this.customerBuild = (color, options) => {
      console.log(`Building ${color} ${this.trim} ${this.model} with the following options: ${options}`);
    }
  }
}
...
const mazda3 = new Car (mazdaOptions);
...
const miataRf = new Sport (miataOptions);
...
const trailBlazer = new Truck (tbOptions);
